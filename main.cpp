...
int main() {
   ...
   */
  std::cout << std::endl
            << "Die Maerchen von TES22 -- Band 2" << std::endl
            << std::endl;
  /*
   * Erstes Kapitel
   */
  ...
  std::cout
      ...
      << std::endl; // erster Satz, neue Sätze in diesem Kapitel erst unter
                    // diesem Satz
   std::cout << std::endl
            << "Was ganz alleine war und auf der Suche nach einem Abenteuer ist." << std::endl
            << std::endl;
  ...
  std::cout << "Es war einmal ein Koenigreich, in dem war seit einem Jahr die "
            ...
            << std::endl; // erster Satz, neue Sätze in diesem Kapitel erst
                          // unter diesem Satz
   std::cout << std::endl
            << "Und die Menschen in diesem Königreich waren sehr traurig." << std::endl
            << std::endl;
